---
title_en: Young GeBA Members Participate in International Biomedical Summer School
  in Batumi
title_ka: GeBA-ს ახალგაზრდა წევრები საერთაშორისო ბიოსამედიცინო საზაფხულო სკოლაში ბათუმში
  მონაწილეობენ
date: 2025-07-15
...
permalink_ka: /pages/news/biomedical-summer-school-batumi-ge.html
  ...
  an international summer school held in Batumi, organized by the Georgian Technical
  University and Batumi Shota Rustaveli State University. Participants of the international
  ...
  ჩაატარონ ლაბორატორიული სამუშაოები შემდეგ სფეროებში: მიკრობიოლოგია, იმუნოქიმია, ბიოქიმია,
  ელექტროფორეზი და ქრომატოგრაფია. პროგრამა განკუთვნილია ბიოტექნოლოგიის, მედიცინის,
  ფარმაციის, ვეტერინარიის, სოფლის მეურნეობის, ბიოქიმიისა და ბიოტექნოლოგიის, კვების
  ტექნოლოგიისა და გარემოს დაცვის სპეციალობის სტუდენტებისთვის.
